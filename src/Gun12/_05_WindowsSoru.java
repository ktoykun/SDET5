 ...
 */
    ...
    public void Test1 () {
     ...
     // her bir sayfaya geçip url ve title ini yazıdrma
           ...
           for(String id: windowsIdLer)
           {
            ...
            // ana sayfa haricinde diğerini nasıl kapatırız.
           for(String id: windowsIdLer)
           {
               if (id.equals(anasayfaWindowId))
                   continue; // anasayfanın id'sine eşitse continue bunu geç dedik

               driver.switchTo().window(id); // sıradaki tabdaki window a geçmiş oldum.
               driver.close();
           }

           // tek for ile de olurdu. anlaşılsın diye böyle yaptık

           // Ek not:
            // driver.quit(); // bu hespini kapatır.
            // driver.close();// bu sadece ilgilisini kapatır
        BekleKapat();
